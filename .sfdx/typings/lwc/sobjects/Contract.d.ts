...
declare module "@salesforce/schema/Contract.Opportunity_Contract__r" {
  const Opportunity_Contract__r:any;
  export default Opportunity_Contract__r;
}
declare module "@salesforce/schema/Contract.Opportunity_Contract__c" {
  const Opportunity_Contract__c:any;
  export default Opportunity_Contract__c;
}
