...
declare module "@salesforce/schema/AccountChangeEvent.isNewCompany__c" {
  const isNewCompany__c:boolean;
  export default isNewCompany__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Potential_Value__c" {
  const Potential_Value__c:number;
  export default Potential_Value__c;
}
declare module "@salesforce/schema/AccountChangeEvent.HyperLink__c" {
  const HyperLink__c:string;
  export default HyperLink__c;
}
declare module "@salesforce/schema/AccountChangeEvent.ControlPIcklist__c" {
  const ControlPIcklist__c:boolean;
  export default ControlPIcklist__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Macroon__c" {
  const Macroon__c:string;
  export default Macroon__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Account_Test__c" {
  const Account_Test__c:any;
  export default Account_Test__c;
}
