...
declare module "@salesforce/schema/CampaignMember.wbsendit__Activity_Date__c" {
  const wbsendit__Activity_Date__c:any;
  export default wbsendit__Activity_Date__c;
}
declare module "@salesforce/schema/CampaignMember.wbsendit__Activity__c" {
  const wbsendit__Activity__c:string;
  export default wbsendit__Activity__c;
}
declare module "@salesforce/schema/CampaignMember.wbsendit__Clicks__c" {
  const wbsendit__Clicks__c:number;
  export default wbsendit__Clicks__c;
}
declare module "@salesforce/schema/CampaignMember.wbsendit__Opens__c" {
