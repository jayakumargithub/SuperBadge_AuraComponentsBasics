...
declare module "@salesforce/schema/ContactChangeEvent.TestMoney__c" {
  const TestMoney__c:number;
  export default TestMoney__c;
}
declare module "@salesforce/schema/ContactChangeEvent.TestNumber__c" {
  const TestNumber__c:number;
  export default TestNumber__c;
}
