...
declare module "@salesforce/schema/Employee__ChangeEvent.CurrencyIsoCode" {
...
declare module "@salesforce/schema/Employee__ChangeEvent.Contact__c" {
  const Contact__c:any;
  export default Contact__c;
}
declare module "@salesforce/schema/Employee__ChangeEvent.First_Name__c" {
  const First_Name__c:string;
  export default First_Name__c;
}
declare module "@salesforce/schema/Employee__ChangeEvent.Last_Name__c" {
  const Last_Name__c:string;
  export default Last_Name__c;
}
declare module "@salesforce/schema/Employee__ChangeEvent.Employee_Ttpe__c" {
  const Employee_Ttpe__c:string;
  export default Employee_Ttpe__c;
}
