...
declare module "@salesforce/schema/OpportunityChangeEvent.IsSplit" {
...
declare module "@salesforce/schema/OpportunityChangeEvent.TestRollup__c" {
  const TestRollup__c:number;
  export default TestRollup__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.Discount_Percent__c" {
  const Discount_Percent__c:number;
  export default Discount_Percent__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.Discount_Percent_Status__c" {
