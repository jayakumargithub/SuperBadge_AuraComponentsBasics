...
declare module "@salesforce/schema/Task.wbsendit__Smart_Email_Id__c" {
  const wbsendit__Smart_Email_Id__c:string;
  export default wbsendit__Smart_Email_Id__c;
}
declare module "@salesforce/schema/Task.wbsendit__Smart_Email_Message_Id__c" {
  const wbsendit__Smart_Email_Message_Id__c:string;
  export default wbsendit__Smart_Email_Message_Id__c;
}
declare module "@salesforce/schema/Task.wbsendit__Smart_Email_Status__c" {
