...
declare module "@salesforce/schema/CampaignMemberChangeEvent.CurrencyIsoCode" {
  const CurrencyIsoCode:string;
  export default CurrencyIsoCode;
}
declare module "@salesforce/schema/CampaignMemberChangeEvent.wbsendit__Activity_Date__c" {
  const wbsendit__Activity_Date__c:any;
  export default wbsendit__Activity_Date__c;
}
declare module "@salesforce/schema/CampaignMemberChangeEvent.wbsendit__Activity__c" {
  const wbsendit__Activity__c:string;
  export default wbsendit__Activity__c;
}
declare module "@salesforce/schema/CampaignMemberChangeEvent.wbsendit__Clicks__c" {
  const wbsendit__Clicks__c:number;
  export default wbsendit__Clicks__c;
}
declare module "@salesforce/schema/CampaignMemberChangeEvent.wbsendit__Opens__c" {
  const wbsendit__Opens__c:number;
  export default wbsendit__Opens__c;
}
